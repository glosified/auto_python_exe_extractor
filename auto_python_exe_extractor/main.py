...
"""
Auto Python Extract V.0.1
Author: LAW
Youtube: https://www.youtube.com/channel/UCbfGHhyeHpKXF5rl1cRfvbg/videos
Script realized thanks to PyInstaller Extractor & Decompile3
...
def starting():
	...
	file = sys.argv[1]
	file_pyc = file.replace('exe', 'pyc')
	os.chdir(f'{directory}')

	folder_location = "./" + file + "_extracted/"
	...
	main(file)
	os.chdir(f'{directory}')
	file_location = "./" + file + "_extracted/" + file_pyc
	shutil.move(file_location, "./Process")
	shutil.rmtree(folder_location)
	file_pyc_location = "./Process/" + file_pyc
	uncompyle(file_pyc)
